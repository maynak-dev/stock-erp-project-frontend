...
export default function CompanyList() {
  ...
  const [editItem, setEditItem] = useState(null); // null = closed, object = open with data
  ...
  return (
    <div>
      ...
      {/* Completely separate Add modal — always starts blank */}
      <AddCompanyModal
        isOpen={showAdd}
      ...
      {/* Separate Edit modal — only mounts data when editItem is set */}
      <EditCompanyModal
        isOpen={!!editItem}
