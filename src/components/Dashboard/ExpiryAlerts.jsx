...
export default function ExpiryAlerts() {
  ...
  return (
    <div style={{
      ...
      alignSelf:'start',         // don't stretch to grid row height
    }}>
        ...
        {alerts.length === 0 ? (
          <div style={{ padding:'40px 0', textAlign:'center' }}>
            <div style={{
              ...
              background:'rgba(15,207,176,0.1)', border:'1px solid rgba(15,207,176,0.2)',
          ...
          alerts.map(item => {
            ...
            return (
              <div key={item.id} style={{
                display:'flex', alignItems:'center', justifyContent:'space-between',
                padding:'9px 8px', borderRadius:'8px', marginBottom:'1px',
              ...
              onMouseLeave={e => e.currentTarget.style.background='transparent'}>
                <div style={{ display:'flex', alignItems:'center', gap:'10px', minWidth:0 }}>
                  <div style={{
                    ...
                    background:u.color, boxShadow:`0 0 6px ${u.color}`,
                  }}/>
                  <div style={{ minWidth:0 }}>
                    <div style={{ fontSize:'13px', fontWeight:500, color:'var(--t1)', whiteSpace:'nowrap', overflow:'hidden', textOverflow:'ellipsis', maxWidth:'200px' }}>
                      {item.product?.name}
                    </div>
                ...
                <div style={{ display:'flex', alignItems:'center', gap:'7px', flexShrink:0 }}>
                  <div style={{
                    ...
                    fontSize:'10px', fontWeight:600, color:u.color,
                  }}>
                    {u.label}
                  </div>
